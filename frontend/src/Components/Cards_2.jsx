    ...
    <div className='w-full py-[10rem] px-4 bg-white'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
        <div className='w-full shadow-xl flex flex-col p-4  my-4 text-center rounded-lg hover:scale-105 duration-300'>
            <img className='mx-auto mt-[-3rem] bg-white' src={Everest} alt="" />
        ...
        <div className='w-full shadow-xl bg-gray-100 flex flex-col p-4 md:my-0 my-8 text-center rounded-lg hover:scale-105 duration-300'>
            <img className='mx-auto mt-[-3rem] bg-transparent' src={Swayambhunath} alt="" />
            <h2 className='text-2xl font-bold text-center py-8'>Swoyambhunath MahaChaitya</h2>
            <p className='text-center text-4xl font-bold'>lorem </p>
            <div className='text-center font-medium'>
              <p className='py-2 border-b mx-8 mt-8'>Lorem, ipsum dolor.</p>
              {/* <p className='py-2 border-b mx-8 '>Lorem, ipsum dolor.</p>
        ...
        <div className='w-full shadow-xl flex flex-col p-4  my-4 text-center rounded-lg hover:scale-105 duration-300'>
            <img className=' mx-auto mt-[-3rem] bg-white' src={Fewa} alt="" />
            <h2 className='text-2xl font-bold text-center py-8 '>Fewa Lake</h2>
            <p className='text-center text-4xl font-bold'>lorem </p>
            <div className='text-center font-medium'>
              <p className='py-2 border-b mx-8 mt-8'>Lorem, ipsum dolor.</p>
